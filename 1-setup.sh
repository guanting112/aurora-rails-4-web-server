...
{
  printf "\n\e[1;36mAurora Rails 4 System Environment (by Guanting Chen)\e[m\n"
...
function setup_software_from_shell()
{
  ...
  local shell_file_path=~/aurora-rails-4-system-environment/$shell_file_name
...
function start_setup_dev_profile()
{
  ...
  cp ~/aurora-rails-4-system-environment/1-install-dev-profile.sh ~/.dev_profile
